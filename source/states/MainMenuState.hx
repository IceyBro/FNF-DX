...
class MainMenuState extends MusicBeatState
{
	...
	var menuCam:FlxCamera; // ✅ Added new menu camera
	...
	function changeItem(change:Int = 0)
	{
		...
		// ✅ Scroll camera to bring selected item to top
		FlxTween.cancelTweensOf(camFollow);
		var offsetY:Float = selectedItem.y - 40;
		if (offsetY < 0) offsetY = 0;
		FlxTween.tween(camFollow, { y: offsetY }, 0.3, { ease: FlxEase.quadOut });
	}
}
